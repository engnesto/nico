                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            <li class="box-label"><a href="#">All TSP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
...
echo "<h3>$row[0]</h3>";
              ?></label></a></li>
              <ul class="list-style-none">
                                            <li class="box-label"><a href="#">All TSTP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
...
echo "<h3>$row[0]</h3>";
              ?></label></a></li>
                            ...
                            <form action="bulkinsert.php" method="post" class="form-horizontal">
<div class="row">
                <div class="form-group col-md-4">
                  <label class="col-md-12">Product</label>
<select class="form-control" id="country-dropdown" name="product1">
...
<select class="form-control" id="state-dropdown" name="category1">
</select>
</div>
<!--<div class="form-group col-md-2">
<label for="name">Bottle Size</label>
<select class="form-control" id="mills-dropdown" name="mills">
</select>
</div>-->

<div class="form-group col-md-2">
<label for="name">A_Quantity</label>
<select class="form-control" id="city-dropdown" name="availquant1" style="
...
<div class="form-group col-md-2">
    <label for="name">NewQuantity</label>
                  <input type="text" name="serialno1" class="form-control" placeholder="Fill ">
                </div>
         
<div class="form-group col-md-2">
<!--<label for="name">Unit_Price</label>-->
<select class="form-control" id="unitprice" name="stock1" style="
      /* apply CSS to the select tag of 
         .dropdown-container div*/
...
<div class="form-group col-md-2">
<!--<label for="name">Unit_Price</label>-->
<select class="form-control" id="buyingunitprice" name="pbp" style="
      /* apply CSS to the select tag of 
         .dropdown-container div*/
...
<br>
                <div class="pull-right">
                    ...
                    <button type="submit"name="submit" class="btn btn-info btn-rounded"  data-target="#add-contact"><i class="fa fa-save"></i>ADD</button>
</div></div></form></div></div></div></div>
<div class="right-aside">
    <form action="bulkdp.php" method="post" class="form-horizontal"><div class="right-page-header">
<div class="table-responsive">
...
$records = mysqli_query($connect,"select * from bulks"); // fetch data from database
...
?>
  <tr>
    ...
    <td><?php echo $data['productbuyingprice']; ?></td>
    <td><?php echo $data['product_unit_price']; ?></td>
    <td><?php echo $data['totalcostofsales']; ?></td>
    <td align="center">
<a class="text-info" href="editbulks.php?id=<?php echo $data["ID"]; ?>">Edit</a>&nbsp;|
<a class="text-danger" href="deletebulks.php?id=<?php echo $data["ID"]; ?>">Delete</a>
</td>
    
  </tr> 
<?php
}
//echo "<a href = 'bulkdp.php'><i class='fa fa-save'></i>Submit</button>";
echo "<button type = 'submit' name='submit'><i class='fa fa-save'></i>Save</button>";
