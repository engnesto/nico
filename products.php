...
echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    ...
    padding: 0;'>" .number_format($row[0])."<br>"."</h3>";
            ...
            <button class="btn btn-primary" name="search"><span class="glyphicon glyphicon-search"></span></button> <a href="products.php" type="button" class="btn btn-success"><span class = "glyphicon glyphicon-refresh"><span></a>
        </form>
    ...
    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                   ...
                   <!-- <th>subcat_id</th>-->
                    <th>TOTAL STOCK</th>
                    <th>STOCK UNIT SELLING PRICE</th>
                    <th>STOCK TOTAL SELLING PRICE</th>
