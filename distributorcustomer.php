...
<?php      
//include("confi.php");
    $query = "SELECT * FROM distributorcustomer;";
    ...
    <?php
        ...
        echo "<tr>";  
        echo '<td colspan="2">';    
        echo '<a href="distributornewcustomer.html"> <button type="button" class="btn btn-info btn-rounded"  data-target="#add-contact">Add New Customer</button></a>';      
        echo "</td>";    
        echo '<td colspan="7">';    
