                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13">Enter products details below only if they do not exist in the product dropdown</p>
                            ...
                            >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="FIRSTNAME" class="form-control" placeholder="Enter full product name..."> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Category <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="LASTNAME" class="form-control" placeholder="Enter full product category name here..."> </div>
                                </div>
