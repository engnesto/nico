...
<!--                     <li> <a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-checkbox-multiple-marked-outline fa-fw"></i> <span class="hide-menu">Multi-Level Dropdown<span class="fa arrow"></span></span></a>
                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            <li class="box-label"><a href="javascript:void(0)">All Products <span>123</span></a></li>
                                            <li class="divider"></li>
                                            <li><a href="javascript:void(0)">Fridges <span>103</span></a></li>
                                            <li><a href="javascript:void(0)">Phones <span>19</span></a></li>
                                            <li><a href="javascript:void(0)">Washing Machines <span>623</span></a></li>
                                            <li><a href="javascript:void(0)">TVs <span>53</span></a></li>
    ...
    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                ...
                <tbody>                                   <div class="scrollable">
                                       ...
                                       <?php
include("confi.php");
    $query = "SELECT * FROM retailproduct;";
