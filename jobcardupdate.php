...
$qry = mysqli_query($connect,"select * from jobcardtbl where id='$id'"); // select query
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Jobcard</h4> </div>
                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            <li class="box-label"><a href="javascript:void(0)">All Jobcards <span><?php
$sql="select count(*) from jobcardtbl;";
...
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="javascript:void(0)">Completed Jobcards <span><?php
$sql="select count(*) from jobcardtbl where STATUS = 'completed';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            
                                            <li><a href="javascript:void(0)">Pending Jobcards <span><?php
$sql="select count(*) from jobcardtbl where STATUS = 'pending';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                ...
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        ...
                                        <h3>Customer Jobcard details</h3> </div>
                                   
                                    <form class="form-horizontal form-material" method="POST" action="updatejobcard.php">
                                       <input type="hidden" name="id" class="txtField" value="<?php echo $data['id']; ?>">

                                        <div class="form-group">
                                            <label class="col-md-12">Customer First Name</label>
                                            <div class="col-md-12">
                                                <input type="text" name="customerfirstname" class="form-control form-control-line"value="<?php echo $data['CUSTOMER_FIRST_NAME'] ?>" > </div>
                                                </div>
                                         <div class="form-group">
                                            <label class="col-md-12">Customer Last Name</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" name="customerlastname" value="<?php echo $data['CUSTOMER_LAST_NAME'] ?>"> </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="payment" class="col-md-12">Payment</label>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="payment mode" name="payment" value="<?php echo $data['PAYMENT'] ?>"class="form-control form-control-line" readonly > </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Payment Details</label>
                                            <div class="col-md-12">
                                                <input type="text" name="paymentdetails" value="<?php echo $data['PAYMENT_DETAILS'] ?>" class="form-control form-control-line" readonly> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Customer Phone Number</label>
                                            <div class="col-md-12">
                                                <input type="text" name= "phoneno"placeholder="+256 456 7890" value="<?php echo $data['PHONE_NO'] ?>" class="form-control form-control-line"> </div>
                                        </div>
                               <div class="form-group">
                                            <label class="col-sm-12">Set new Jobcard Status</label>
                                            <div class="col-sm-12">
                                            ...
                                            <option>NEW JOB CARD</option>
                                            <option>RENDY TO COLLECT</option>
                                        </select>       
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <INPUT type = "text" name = "remarks" class="form-control form-control-line" value="<?php echo $data['REMARKS'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
