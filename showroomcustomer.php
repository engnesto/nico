                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="javascript:void(0)">Customers <span><?php
$sql="select count(*) from retailcustomer";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            <li><a href="javascript:void(0)">Aftersales <span>19</span></a></li>
                                            <li><a href="javascript:void(0)">Distributors <span>623</span></a></li>
                                            <li><a href="javascript:void(0)">Retailers <span>53</span></a></li>
                                ...
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        ...
                                        <h3>After Sales Customers</h3> </div>
...
<?php      
//include("confi.php");
    $query = "SELECT * FROM showroomcustomer;";
    ...
    if($res >0){
        ...
        while($rows = mysqli_fetch_assoc($result)){
            ...
            echo "<td>".$rows["WHATSAPP"]."</td>";
            echo "<td>".$rows["EMAIL"]."</td>";
            echo "<td>".$rows["PRODUCT"]."</td>";
            echo "<td>".$rows["SERIALNO"]."</td>";
            echo "<td>".$rows["WARRANTYPERIOD"]."</td>";
            echo "<td>".$rows["PRODUCTDETAILS"]."</td>";            
            echo "</tr>";
    ...
    <?php
        ...
        echo "<tr>";  
        echo '<td colspan="2">';    
        echo '<a href="showroomnewcustomer.html"> <button type="button" class="btn btn-info btn-rounded"  data-target="#add-contact">Add New Customer</button></a>';      
        echo "</td>";    
        echo '<td colspan="7">';    
