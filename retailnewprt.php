                        ...
                        <ul class="nav nav-second-level"><!-- 
                            ...
                            <li><a href="javascript:void(0)" class="waves-effect"><i class="ti-user fa-fw"></i><span class="hide-menu">CRM</span><span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                   ...
                                   <li> <a href="products.php"><i class="icon-people fa-fw"></i><span class="hide-menu">Products</span></a></l>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <form action="retailnewproduct.php" method="post" class="form-horizontal">
...
self.location='retailnewprt.php?cat=' + val ;
}
//-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="model" class="form-control">
                                            <option>OLED2K</option>
                                            <option>QLED8K</option>
                                            <option>QLED4K</option>
...
<!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="serialno" class="form-control" placeholder="S/N"> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Status</label>
                                    <div class="col-md-12">
                                        <input type="text" name="status" class="form-control" placeholder="Sold/Still in stock?"> </div>
                                </div>
                                <div class="form-group">
