    ...
    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                ...
                <tbody>
                                    <div class="scrollable">
                                        <?php
//include("confi.php");
    $query = "SELECT * FROM jobcardtbl where STATUS = 'NEW';";
    ...
    if($res >0){
        ...
        while($row = mysqli_fetch_assoc($result)){?>
         ...
         <td><?php echo $row['PAYMENT_DETAILS'];?></td>
            ...
            <A HREF="jobcard.php?uid=<?php echo $row["id"];?>" class="btn btn-info btn-rounded"><span class="glyphicon glyphicon-print"></span>Print</a></td>
             </tr>
          <?php $cnt=$cnt+1; }?>          
<?php $cnt=$cnt+1; }?>
