                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            <li class="box-label"><a href="productsall.php">All Products <span><?php
$sql="select count(*) from inventorytbl where status != 'sold';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            <li class="divider"></li>
                                            <li><a href="beer.php">Beer<span><?php
$sql="select count(*) from inventorytbl where categories = 'beer' and status != 'sold'";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            <li><a href="water.php">Water<span><?php
$sql="select count(*) from inventorytbl where categories = 'water'";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
                                            <li><a href="soda.php">Soda<span><?php
$sql="select count(*) from inventorytbl where categories = 'soda'";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></span></a></li>
