...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <!-- Page Content -->
        <!-- ============================================================== -->
        <form action="sales_add.php" method="post" class="form-horinzontal">
     <?php 
//include 'confi.php';
      $ret=mysqli_query($connect,"select * from inventorytbl where id='".$_GET['uid']."'");
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            <p class="text-muted m-b-30 font-13"> Enter Quantity to sell here </p>
...
<!--<div class="col-md-12">
                                        <input type="text" name="model" class="form-control" placeholder="Input model details if not exist in drop downlist"> </div>-->
...
<!--<div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="hidden" name="mid" class="form-control" value="<?php echo $row['ID'];?>" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product</label>
                                    <div class="col-md-12">
                                        <input type="text" name="product" class="form-control" value="<?php echo $row['PRODUCT'];?>" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Category</label>
                                    <div class="col-md-12">
                                        <input type="text" name="category" class="form-control" value="<?php echo $row['CATEGORY'];?>" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Available Quantity</label>
                                    <div class="col-md-12">
                                        <input type="text" name="availablequantity" class="form-control" value="<?php echo $row['total_stock'];?>" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Unit Selling Price</label>
                                    <div class="col-md-12">
                                        <input type="text" name="pprice" class="form-control" value="<?php echo $row['stock_unit_selling_price'];?>" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Enter total quantity to sell</label>
                                    <div class="col-md-12">
                                        <input type="text" name="units" class="form-control" placeholder="Enter units to sell"> </div>
                                </div>
                               <!-- <div class="form-group">
                                ...
                                <button type="submit"name="submit" class="btn btn-info btn-rounded"  data-target="#add-contact"><i class="fa fa-save"></i>Sale</button>
                            </div><?php } ?>
                            </form>
                        </div>
                    </div>
