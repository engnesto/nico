...
echo "<h3>$row[0]</h3>";
              ?></label></a></li>
              <ul class="list-style-none">
                                            <li class="box-label"><a href="#">Water TSTP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
$sql="select sum(stock_total_buying_price) from inventorytbl where PRODUCT = 'water';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?></label></a></li>
...
$pages_to_right = 2;
                      ...
                      $pagesql= "SELECT * from inventorytbl  where PRODUCT = 'water' limit ". $page_result_number .','.$records_per_page;
