            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">New Product Entry</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13">Fill all fields below. </p>
                            <form class="form-horizontal" action="product_add.php" method="POST"
                            >
                                <div class="form-group">
                                    <label class="col-md-12">Product Name <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="FIRSTNAME" class="form-control" placeholder="Enter full product name..." required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Category <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="LASTNAME" class="form-control" placeholder="Enter full product category name here..." required> </div>
                                </div>
                                 <div class="form-group">

                                    <button type="submit" name="submit" class="btn btn-info btn-rounded" a data-target="#add-contact"><i class="fa fa-save"></i>Add New Product/Category</button>
