...
<body class="fix-header">
 ...
 <div class="form-group col-md-12">                              
             <select class="form-control" id="country-dropdown" name="cat" required>
...
<select class="form-control" id="state-dropdown" name="subcat" required>
</select>
</div> 
<div class="form-group col-md-12">
<!--<label for="name" class="col-md-12">Bottle Size</label>-->
<select id="mills-dropdown" name="mills" style="
...
<p>  below Click below button incase one of the two above does not exist and please fill all fields, then select again Thanks.</p> 
...
<!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="serialno" class="form-control" placeholder="Enter Quantity Here" required> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Product buying Price</label>
                                    <div class="col-md-12">
                                        <input type="text" name="ubprice" class="form-control" placeholder="How much did you buy a unit of this product?" required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Selling Price</label>
                                    <div class="col-md-12">
                                        <input type="text" name="pprice" class="form-control" placeholder="Enter unit product selling Price" required> </div>
                                </div>
                                <div class="form-group">
