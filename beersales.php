                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            <li class="box-label"><a href="sales.php">TSQ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
...
echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    ...
    padding: 0;'>" .number_format($row[0])."<br>"."</h3>";
              ...
              ?></label></a></li>
              <ul class="list-style-none">
                                            <li class="box-label"><a href="#">Beer TCOS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
$sql="select sum(totalcostofsales) from salestbl where product = 'beer';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    margin: 0 0 10px 0;
...
echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    ...
    padding: 0;'>" .number_format($row[0])."<br>"."</h3>";
              ...
              ?></label></a></li>
                                            <li><a href="watersales.php">Water &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><?php
...
$pages_to_right = 2;
                      ...
                      $pagesql= "SELECT * from salestbl where product = 'beer' limit ". $page_result_number .','.$records_per_page;
