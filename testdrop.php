            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">New Product</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            <p class="text-muted m-b-30 font-13"> Enter New Product Here </p>
...
self.location='newprt.php?cat=' + val ;
}
//-->
...
?>
<!--<div class="col-md-12">
                                        <input type="text" name="model" class="form-control" placeholder="Input model details if not exist in drop downlist"> </div>--><br><br>
<!--<a href=newprt.php>Reset and start again</a>

<br><br>
<center><a href='http://www.plus2net.com' rel="nofollow">PHP SQL HTML free tutorials and scripts</a></center>-->
 <div class="form-group">
                                    <label class="col-md-12">Mills</label>
                                    <div class="col-md-12">
                                       <select name="mills" class="form-control">
        <option value="">Select size</option>
        <option name="mills" >300mls</option>
        <option name="mills" >350mls</option>
        <option name="mills" >400mls</option>
        <option name="mills" >500mls</option>
        <option name="mills" >600mls</option>
        <option name="mills" >650mls</option>
        <option name="mills" >1 liter</option>
        <option name="mills" >1.5 liters</option>
        <option name="mills" >2 liters</option>
    </select>
                                </div>

<p>Click button below incase one of the three above does not exist and please fill all fields, then select again Thank you.</p> 
<a href="product_modal.php"> <button type="button" class="btn btn-info btn-rounded"  data-target="#add-contact">Add New Product/Category</button></a>

                               
                                
                                <!-- <div class="form-group">
                                    <label class="col-sm-12">Dealer</label>
                                    <div class="col-sm-12">
...
<!--<div class="form-group">
                                    <label class="col-md-12">Dealer Details</label>
                                    <div class="col-md-12">
                                        <input type="text" name="serialno" class="form-control" placeholder="Input Dealer details"> </div>
                                </div> -->                               
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="serialno" class="form-control" placeholder="Enter Quantity Here"> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Product buying Price</label>
                                    <div class="col-md-12">
                                        <input type="text" name="ubprice" class="form-control" placeholder="How much did you buy a unit of this product?"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Selling Price</label>
                                    <div class="col-md-12">
                                        <input type="text" name="pprice" class="form-control" placeholder="Enter unit product selling Price"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit"name="submit" class="btn btn-info btn-rounded"  data-target="#add-contact"><i class="fa fa-save"></i>Create</button>
                            </div>
                            </form>
                        </div>
                    </div>
