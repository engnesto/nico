                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="inbox.html" class="waves-effect"><i class="mdi mdi-apps fa-fw"></i> <span class="hide-menu">Apps<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level"><!-- 
                            ...
                            <li><a href="javascript:void(0)" class="waves-effect"><i class="ti-user fa-fw"></i><span class="hide-menu">CRM</span><span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li> <a href="customer.php"><i class="icon-people fa-fw"></i><span class="hide-menu">Customers</span></a></li>
                                   <li> <a href="products.php"><i class="icon-people fa-fw"></i><span class="hide-menu">Products</span></a></li>
                                    <li> <a href="job-cards.php"><i class="icon-people fa-fw"></i><span class="hide-menu">Job cards</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Service Order & Follow up Card</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Job Card</h3>
                            <p class="text
                            "> Fill this form </p>
                            <form action="newjobcard.php" method="post" class="form-horizontal">

                                 <div class="form-group">
                                    <label class="col-md-12">Job Card Number Captured <span class="help"></span></label>
                                    
                                    <!--<div class="col-md-12">
                                        <input type="text" name="jobcardno" class="form-control" placeholder="Job Card Number"> </div>-->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    echo "<label class='col-md-12' >Product</label><br>";
//***************************************
...
self.location='newjob-card.php?cat=' + val ;
}
//-->
...
echo "<form method=post name=f1 action= 'newjobcard.php'>";
//////////        Starting of first drop downlist /////////
echo "<div class='col-md-12'> ";
echo "<select name='cat' onchange=\"reload(this.form)\"class='form-control'><option value=''>Select one</option>";
if($stmt = $connection->query("$query2")){
    while ($row2 = $stmt->fetch_assoc()) {
    if($row2['cat_id']==@$cat){echo "<option selected value='$row2[category]'>$row2[category]</option>";}
...
echo "<br><br>";
echo "<label class='col-md-12'>Category</label><br>";
echo "<div class='col-md-12'> ";
echo "<select name='subcat'class='form-control'><option value=''>Select one</option>";
...
echo "<br><br>";
echo "<label class='col-md-12' >Model</label><br>";
echo "<div class='col-md-12'> ";
echo "<select name='model'class='form-control'><option value=''>Select one</option>";

if(isset($cat) and strlen($cat) > 0){
if($stmt = $connection->prepare("SELECT DISTINCT model FROM model where subcat_id=? order by model")){
$stmt->bind_param('i',$cat);
$stmt->execute();
 $result = $stmt->get_result();
 while ($row1 = $result->fetch_assoc()) {
  echo  "<option  value='$row1[model]'s>$row1[model]</option>";
    }
...
?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="warrantyno" class="form-control" placeholder="Enter Serial Number Here"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Product Details <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="productdetails" class="form-control" placeholder="Enter product details"> </div>
                                </div> 
                               <div class="form-group">
                                    <label class="col-md-12">Date Of Report <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="Date" name="dateofreport" class="form-control" placeholder="Date of report"> </div>
                                </div> 
                               
                                <div class="form-group">
                                    <label class="col-md-12">Date Of Completion <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="Date" name="dateofcompletion" class="form-control" placeholder="Date of completion"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Date of Return <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="Date" name="returndate" class="form-control" placeholder="Date of return"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Customer First Name <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="customerfirstname" class="form-control" placeholder="customername"required> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Customer Last Name <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="customerlastname" class="form-control" placeholder="customername"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Receiver's Name <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="receivername" class="form-control" placeholder="receivername"required> </div>
                                </div>                       
                                <div class="form-group">
                                    <label class="col-sm-12">Dealer's Name</label>
                                    <div class="col-sm-12">
                                        <select name="dealername" class="form-control"required>
...
<div class="form-group">
                                    <label class="col-sm-12">Payment</label>
                                    <div class="col-sm-12">
                                 ...
                                 <div class="form-group">
                                    <label class="col-md-12">Payment Details<span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="text" name="paymentdetails" class="form-control" placeholder="Please Enter your Payment Details here "required> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Date of Purchase<span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="date" name="dateofpurchase" class="form-control" placeholder="Please Enter your Payment Details here "required> </div>
                                </div>
                                                          <div class="form-group">
                                    <label class="col-md-12">Whatsapp Number <span class="help"></span></label>

                                    <div class="col-md-12">
                                        

                                        <input type="text" list="cars" name="whatsapp" class="form-control" placeholder = "Uganda (+256) and Kenya (+254) country code" required="true" autocomplete="off"/>
<datalist id="cars">
  <option>+256</option>
  <option>+254</option>
  </datalist>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Phone Number <span class="help"></span></label>
  <div class="col-md-12">
   
   <input id="phone" type="tel"  name="phone" class="form-control"  required="true"  />

                                         </div>
                                </div>
                                <!--<div class="form-group">
                                    <label class="col-md-12">Receipt Number</label>
                                    <div class="col-md-12">
                                        <input type="text" name="receiptno" class="form-control" placeholder="Receipt Number"> </div>
                                </div>-->
                                <div class="form-group">
                                    <label class="col-md-12">Warranty Number</label>
                                    <div class="col-md-12">
                                        <input type="text" name="warrantyno" class="form-control" placeholder="Enter Warranty Number if Applicable"> </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-md-12">Customer Location</label>
                                    <div class="col-md-12">
                                        <input type="text" name="customerlocation" class="form-control" placeholder="Customer Location"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="example-email">Email <span class="help"></span></label>
                                    <div class="col-md-12">
                                        <input type="email" id="example-email" name="email" class="form-control" placeholder="Email"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Collection Point</label>
                                    <div class="col-md-12">
                                        <input type="text" name="collectionpoint" class="form-control" placeholder="Commodity collection point"> </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-12">Problem Description</label>
                                    <div class="col-sm-12">
                                        <select name="problemdescription" class="form-control">
                                            <option>Technician sort out the problem at the point of collection</option>
                                            <option>Stock exchange at the point of collection</option>
                                            <option>Stock collected at the point of collection</option>
                                            <option>Others</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Status Of the Commodity</label>
                                    <div class="col-md-12">
                                ...
                                <button type="submit" name="submit" class="btn btn-info btn-rounded"  data-target="#add-contact">Create</button>                              
                            </form>
                        </div>
                    </div>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2021 &copy; Emvigo Technologies </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
