...
$result = $connect->query("SELECT category, quantity FROM salestbl WHERE date = '$today' ORDER BY category DESC");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <ul class="nav nav-second-level">
                           <!--  <li><a href="chat.html"><i class="ti-comments-smiley fa-fw"></i><span class="hide-menu">Chat-message</span></a></li>
                            ...
                            <li><a href="javascript:void(0)" class="waves-effect"><i class="ti-user fa-fw"></i><span class="hide-menu">SECTIONS</span><span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li> <a href="purchase.php"><i class="icon-people fa-fw"></i><span class="hide-menu">Purchaces</span></a></li>
...
echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    ...
    padding: 0;'>$row[0]</h3>";
              ?>
 <p style="color: black">Opening stock</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-warning">
            <div class="inner">
              <?php
                $sql = "SELECT sum(totalcostofsales) FROM salestbl where date='$today'; ";
               $result=mysqli_query($connect,$sql);
               $row=mysqli_fetch_array($result);
               echo "<h3 style='z-index: 5; font-size: 28px; font-weight: bold;
    margin: 0 0 10px 0;
...
<!--        <div class="col-md-4">
 ...
 <div class="card-header" style="font-size: 15px; text-align: center;">A PieChart Showing Weekly Sales Progress</div>
 <div class="card-body"> 
 <div class="chart-container pie-chart">      
<div id="piechart"></div></div></div></div>
        </div>       
        <div class="col-md-8" style="background-color: white;">
          <div class="card mt-4 mb-4">
            <div class="card-header"style="font-size: 15px; text-align: center;">Bar graph showing monthly sales Progress</div>
            <div class="card-body">
              <div class="chart-container pie-chart">
