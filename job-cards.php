            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Job Cards</h4> </div>
                                ...
                                <div class="left-aside">
                                    <div class="scrollable">
                                        <ul class="list-style-none">
                                            ...
                                            <li class="box-label"><a href="javascript:void(0)"><a name = "Submit" href="job-cardall.php">All Job Cards <span><?php
...
echo "<h3>$row[0]</h3>";
              ?></span></a></a></li>
                                            <li class="divider"></li>
                                            <li><a href="javascript:void(0)"><a name = "Submit" href="jobcardnew.php">New Job Cards <span>
<?php
$sql="select count(*) from jobcardtbl where STATUS = 'NEW';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
              ?>
                                            </span></a></li>
                                            <li><a href="javascript:void(0)"><a name = "Submit" href="jobcardpending.php">Pending Job Cards<span>
<?php
...
echo "<h3>$row[0]</h3>";
              ?>
                                            ...
                                            <li><a href="javascript:void(0)"><a name = "Submit" href="jobcardcompleted.php">Ready to Collect <span>
<?php
...
echo "<h3>$row[0]</h3>";
              ?>
                                            ...
                                            <li><a href="javascript:void(0)"><a name = "Submit" href="jobcardcompleted.php">Completed Job Cards <span>
<?php
$sql="select count(*) from jobcardtbl where STATUS = 'completed';";
$result=mysqli_query($connect,$sql);
$row=mysqli_fetch_array($result);
echo "<h3>$row[0]</h3>";
             ...
             <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            ...
                            <label class="col-md-12">Name of Label</label>
                              <div class="col-md-12">
                          <nput type="text" class="form-control" placeholder="type name"> </div>
                                                                </div>
                                                                <div class="form-group">
                                ...
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        <div class="pull-right">
                                            <a href="newjob-card.php"> <button type="button" class="btn btn-info btn-rounded"  data-target="#add-contact">Add New Job Card</button></a>
                                        </div>
                                        <h3>Job Cards </h3> </div>
...
//include("confi.php");
    $records_per_page = 10;
    $total_records = "SELECT * FROM jobcardtbl;";
...
$pages_to_right = 2;
                      ...
                      $pagesql= "SELECT * from jobcardtbl limit ". $page_result_number .','.$records_per_page;
         ...
         <?php echo "<td>".$row['CUSTOMER_FIRST_NAME'].' '.$row['CUSTOMER_LAST_NAME']."</td>";?>
         ...
         <td><?php echo $row['PAYMENT_DETAILS'];?></td>
            ...
            <A HREF="jobcard.php?uid=<?php echo $row["id"];?>" class="btn btn-info btn-rounded"><span class="glyphicon glyphicon-print"></span>Print</a>
                <A HREF="quantity.php?uid=<?php echo $row["id"];?>" class="btn btn-info btn-rounded"><span class="glyphicon glyphicon-print"></span>Print</a>
            <a name = "Submit"  class="btn btn-success btn-rounded" href="jobcardupdate.php?id=<?php echo $row["id"]; ?>">Update</a>
...
<?php $cnt=$cnt+1; ?>
    ...
    <?php
        ...
        echo "<tr>";  
        echo '<td colspan="2">';    
        echo '<a href="newjob-card.php"> <button type="button" class="btn btn-info btn-rounded"  data-target="#add-contact">Add New Job Card</button></a>'; 
